...
const BLOG = {
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'article/%post_id%',
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'codeva-z5Z8MRiffB', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'p4zno284ay', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'google.com, pub-9087410721665868, DIRECT, f08c47fec0942fa0', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
